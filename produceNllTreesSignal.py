...
ROOT.gROOT.ProcessLine(\
					   "struct MyDileptonTreeFormat{\
						 ...
						 Double_t weightDown;\
						 Double_t bTagWeight;\
						 Double_t bTagWeightErrHeavy;\
						 Double_t bTagWeightErrLight;\
						 Double_t ISRCorrection;\
						 Double_t ISRUncertainty;\
						 ...
						 Double_t leptonFastSimScaleFactor1;\
						 Double_t leptonFastSimScaleFactor2;\
						 Double_t leptonFastSimScaleFactorErr1;\
						 Double_t leptonFastSimScaleFactorErr2;\
						 Double_t genWeight;\
						 Double_t motherPdgId1;\
						 Double_t motherPdgId2;\
						 Double_t scaleWeight1;\
						 Double_t scaleWeight2;\
						 Double_t scaleWeight3;\
						 Double_t scaleWeight4;\
						 Double_t scaleWeight5;\
						 Double_t scaleWeight6;\
						 Double_t scaleWeight7;\
						 Double_t scaleWeight8;\
						};")
...
def convertDileptonTree(tree,inputFileNames,isMC):
	...
	FastSimElectronIDScaleFactorFile = TFile(inputFileNames["FastSimElectronIDScaleFactorFile"])
	FastSimElectronIDScaleFactorHisto = TH2D(FastSimElectronIDScaleFactorFile.Get(inputFileNames["FastSimElectronIDScaleFactorHisto"]))
	
	FastSimElectronIsoScaleFactorFile = TFile(inputFileNames["FastSimElectronIsoScaleFactorFile"])
	FastSimElectronIsoScaleFactorHisto = TH2D(FastSimElectronIsoScaleFactorFile.Get(inputFileNames["FastSimElectronIsoScaleFactorHisto"]))
	
	FastSimElectronConvVetoScaleFactorFile = TFile(inputFileNames["FastSimElectronConvVetoScaleFactorFile"])
	FastSimElectronConvVetoScaleFactorHisto = TH2D(FastSimElectronConvVetoScaleFactorFile.Get(inputFileNames["FastSimElectronConvVetoScaleFactorHisto"]))
	
	
	FastSimMuonIDScaleFactorFile = TFile(inputFileNames["FastSimMuonIDScaleFactorFile"])
	FastSimMuonIDScaleFactorHisto = TH2D(FastSimMuonIDScaleFactorFile.Get(inputFileNames["FastSimMuonIDScaleFactorHisto"]))
	
	FastSimMuonIsoScaleFactorFile = TFile(inputFileNames["FastSimMuonIsoScaleFactorFile"])
	FastSimMuonIsoScaleFactorHisto = TH2D(FastSimMuonIsoScaleFactorFile.Get(inputFileNames["FastSimMuonIsoScaleFactorHisto"]))
	
	FastSimMuonIP2DScaleFactorFile = TFile(inputFileNames["FastSimMuonIP2DScaleFactorFile"])
	FastSimMuonIP2DScaleFactorHisto = TH2D(FastSimMuonIP2DScaleFactorFile.Get(inputFileNames["FastSimMuonIP2DScaleFactorHisto"]))
	
	FastSimMuonSIP3DScaleFactorFile = TFile(inputFileNames["FastSimMuonSIP3DScaleFactorFile"])
	FastSimMuonSIP3DScaleFactorHisto = TH2D(FastSimMuonSIP3DScaleFactorFile.Get(inputFileNames["FastSimMuonSIP3DScaleFactorHisto"]))
	...
	newTree.Branch("nGenVertices", ROOT.AddressOf(data, "nGenVertices"), "nGenVertices/I")
	...
	newTree.Branch("MT2JESUp", ROOT.AddressOf(data, "MT2JESUp"), "MT2JESUp/D")
	newTree.Branch("MT2JESDown", ROOT.AddressOf(data, "MT2JESDown"), "MT2JESDown/D")
	...
	newTree.Branch("genMetPdfVal", ROOT.AddressOf(data, "genMetPdfVal"), "genMetPdfVal/D")
	newTree.Branch("nLL", ROOT.AddressOf(data, "nLL"), "nLL/D")
	newTree.Branch("nLLGenMet", ROOT.AddressOf(data, "nLLGenMet"), "nLLGenMet/D")
	...
	newTree.Branch("bTagWeightErrHeavy", ROOT.AddressOf(data, "bTagWeightErrHeavy"), "bTagWeightErrHeavy/D")
	newTree.Branch("bTagWeightErrLight", ROOT.AddressOf(data, "bTagWeightErrLight"), "bTagWeightErrLight/D")
	newTree.Branch("ISRCorrection", ROOT.AddressOf(data, "ISRCorrection"), "ISRCorrection/D")
	newTree.Branch("ISRUncertainty", ROOT.AddressOf(data, "ISRUncertainty"), "ISRUncertainty/D")
	...
	newTree.Branch("leptonFastSimScaleFactor1", ROOT.AddressOf(data, "leptonFastSimScaleFactor1"), "leptonFastSimScaleFactor1/D")
	newTree.Branch("leptonFastSimScaleFactor2", ROOT.AddressOf(data, "leptonFastSimScaleFactor2"), "leptonFastSimScaleFactor2/D")
	newTree.Branch("leptonFastSimScaleFactorErr1", ROOT.AddressOf(data, "leptonFastSimScaleFactorErr1"), "leptonFastSimScaleFactorErr1/D")
	newTree.Branch("leptonFastSimScaleFactorErr2", ROOT.AddressOf(data, "leptonFastSimScaleFactorErr2"), "leptonFastSimScaleFactorErr2/D")
	...
	newTree.Branch("scaleWeight1", ROOT.AddressOf(data, "scaleWeight1"), "scaleWeight1/D")
	newTree.Branch("scaleWeight2", ROOT.AddressOf(data, "scaleWeight2"), "scaleWeight2/D")
	newTree.Branch("scaleWeight3", ROOT.AddressOf(data, "scaleWeight3"), "scaleWeight3/D")
	newTree.Branch("scaleWeight4", ROOT.AddressOf(data, "scaleWeight4"), "scaleWeight4/D")
	newTree.Branch("scaleWeight5", ROOT.AddressOf(data, "scaleWeight5"), "scaleWeight5/D")
	newTree.Branch("scaleWeight6", ROOT.AddressOf(data, "scaleWeight6"), "scaleWeight6/D")
	newTree.Branch("scaleWeight7", ROOT.AddressOf(data, "scaleWeight7"), "scaleWeight7/D")
	newTree.Branch("scaleWeight8", ROOT.AddressOf(data, "scaleWeight8"), "scaleWeight8/D")
	...
	for i in xrange(iMax):
		if (tree.GetEntry(i) > 0):
			...
			data.weightUp = tree.weightUp
			data.weightDown = tree.weightDown
			data.bTagWeight = tree.bTagWeight
			data.bTagWeightErrHeavy = tree.bTagWeightErrHeavy
			data.bTagWeightErrLight = tree.bTagWeightErrLight
			#~ data.leptonFullSimScaleFactor1 = tree.leptonFullSimScaleFactor1
			#~ data.leptonFullSimScaleFactor2 = tree.leptonFullSimScaleFactor2
			#~ data.leptonFastSimScaleFactor1 = tree.leptonFastSimScaleFactor1
			#~ data.leptonFastSimScaleFactor2 = tree.leptonFastSimScaleFactor2
			...
			if abs(tree.pdgId1) == 11:
				...
				fastSimSF1 = fastSimSF1 * FastSimElectronIDScaleFactorHisto.GetBinContent(FastSimElectronIDScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronIDScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF1 = fastSimSF1 * FastSimElectronIsoScaleFactorHisto.GetBinContent(FastSimElectronIsoScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronIsoScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF1 = fastSimSF1 * FastSimElectronConvVetoScaleFactorHisto.GetBinContent(FastSimElectronConvVetoScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronConvVetoScaleFactorHisto.GetYaxis().FindBin(tempEta))
				
				### 2% uncertainty for FastSim factors
			...
			if abs(tree.pdgId1) == 13:
				...
				fastSimSF1 = fastSimSF1 * FastSimMuonIDScaleFactorHisto.GetBinContent(FastSimMuonIDScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimMuonIDScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF1 = fastSimSF1 * FastSimMuonIsoScaleFactorHisto.GetBinContent(FastSimMuonIsoScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimMuonIsoScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF1 = fastSimSF1 * FastSimMuonIP2DScaleFactorHisto.GetBinContent(FastSimMuonIP2DScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimMuonIP2DScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF1 = fastSimSF1 * FastSimMuonSIP3DScaleFactorHisto.GetBinContent(FastSimMuonSIP3DScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimMuonSIP3DScaleFactorHisto.GetYaxis().FindBin(tempEta))
			...
			if abs(tree.pdgId2) == 11:
				...
				fastSimSF2 = fastSimSF2 * FastSimElectronIDScaleFactorHisto.GetBinContent(FastSimElectronIDScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronIDScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF2 = fastSimSF2 * FastSimElectronIsoScaleFactorHisto.GetBinContent(FastSimElectronIsoScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronIsoScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF2 = fastSimSF2 * FastSimElectronConvVetoScaleFactorHisto.GetBinContent(FastSimElectronConvVetoScaleFactorHisto.GetXaxis().FindBin(tempPt),FastSimElectronConvVetoScaleFactorHisto.GetYaxis().FindBin(tempEta))
			...
			if abs(tree.pdgId2) == 13:
				...
				fastSimSF2 = fastSimSF2 * FastSimMuonIDScaleFactorHisto.GetBinContent(FastSimMuonIDScaleFactorHisto.GetXaxis().FindBin(tempPtFast),FastSimMuonIDScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF2 = fastSimSF2 * FastSimMuonIsoScaleFactorHisto.GetBinContent(FastSimMuonIsoScaleFactorHisto.GetXaxis().FindBin(tempPtFast),FastSimMuonIsoScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF2 = fastSimSF2 * FastSimMuonIP2DScaleFactorHisto.GetBinContent(FastSimMuonIP2DScaleFactorHisto.GetXaxis().FindBin(tempPtFast),FastSimMuonIP2DScaleFactorHisto.GetYaxis().FindBin(tempEta))
				fastSimSF2 = fastSimSF2 * FastSimMuonSIP3DScaleFactorHisto.GetBinContent(FastSimMuonSIP3DScaleFactorHisto.GetXaxis().FindBin(tempPtFast),FastSimMuonSIP3DScaleFactorHisto.GetYaxis().FindBin(tempEta))
			...
			data.leptonFastSimScaleFactor1 = fastSimSF1
			data.leptonFastSimScaleFactor2 = fastSimSF2
			data.leptonFastSimScaleFactorErr1 = fastSimSFErr1
			data.leptonFastSimScaleFactorErr2 = fastSimSFErr2
			data.genWeight = tree.genWeight
			data.scaleWeight1 = tree.scaleWeight1
			data.scaleWeight2 = tree.scaleWeight2
			data.scaleWeight3 = tree.scaleWeight3
			data.scaleWeight4 = tree.scaleWeight4
			data.scaleWeight5 = tree.scaleWeight5
			data.scaleWeight6 = tree.scaleWeight6
			data.scaleWeight7 = tree.scaleWeight7
			data.scaleWeight8 = tree.scaleWeight8
			...
			data.nISRJets = tree.nISRJets
			data.nUnmatchedJets = tree.nUnmatchedJets
			data.ISRCorrection = tree.ISRCorrection
			data.ISRUncertainty = tree.ISRUncertainty
			...
			data.nGenVertices = tree.nGenVertices
			...
			data.eta1 = tree.eta1
			data.eta2 = tree.eta2
			if abs(tree.jet1.Phi() - tree.vMet.Phi()) < pi:
				data.deltaPhiJetMet1 = abs(tree.jet1.Phi() - tree.vMet.Phi())
			else:
				data.deltaPhiJetMet1 = 2*pi - abs(tree.jet1.Phi() - tree.vMet.Phi())
			if abs(tree.jet2.Phi() - tree.vMet.Phi()) < pi:
				data.deltaPhiJetMet2 = abs(tree.jet2.Phi() - tree.vMet.Phi())
			else:
				data.deltaPhiJetMet2 = 2*pi - abs(tree.jet2.Phi() - tree.vMet.Phi())
			...
			if math.isnan(tree.MT2) or math.isinf(tree.MT2) or tree.MT2 > 10000.:
				...
				data.MT2 = tree.MT2
			data.MT2JESUp = tree.MT2JESUp
			data.MT2JESDown = tree.MT2JESDown
			data.pt = tree.p4.Pt()
			...
			w.var("met_Edge").setVal(tree.genMet)
			obsMet = ROOT.RooArgSet(w.var("met_Edge"))
			...
			obsMet = ROOT.RooArgSet(w.var("met_Edge"))
			obsMlb = ROOT.RooArgSet(w.var("sum_mlb_Edge"))
			metJESUpPdfVal = metPdf.getVal(obsMet)
			sumMlbJESUpPdfVal = sumMlbPdf.getVal(obsMlb)	
			w.var("met_Edge").setVal(tree.metJESDown)
			w.var("sum_mlb_Edge").setVal(tree.sumMlbJESDown)
			obsMet = ROOT.RooArgSet(w.var("met_Edge"))
			obsMlb = ROOT.RooArgSet(w.var("sum_mlb_Edge"))
			metJESDownPdfVal = metPdf.getVal(obsMet)	
			sumMlbJESDownPdfVal = sumMlbPdf.getVal(obsMlb)
			
			
			data.nLL = - TMath.Log(data.ptPdfVal) - TMath.Log(data.sumMlbPdfVal) - TMath.Log(data.metPdfVal) - TMath.Log(data.deltaPhiPdfVal)
			data.nLLGenMet = - TMath.Log(data.ptPdfVal) - TMath.Log(data.sumMlbPdfVal) - TMath.Log(data.genMetPdfVal) - TMath.Log(data.deltaPhiPdfVal)
			data.nLLJESUp = - TMath.Log(data.ptPdfVal) - TMath.Log(sumMlbJESUpPdfVal) - TMath.Log(metJESUpPdfVal) - TMath.Log(data.deltaPhiPdfVal)
			data.nLLJESDown = - TMath.Log(data.ptPdfVal) - TMath.Log(sumMlbJESDownPdfVal) - TMath.Log(metJESDownPdfVal) - TMath.Log(data.deltaPhiPdfVal)
...
def main():
	...
	cut +=  "&& Flag_HBHENoiseFilter > 0 && Flag_HBHENoiseIsoFilter > 0 && Flag_goodVertices > 0 && Flag_EcalDeadCellTriggerPrimitiveFilter > 0"
	#~ cut +=  "&& badPFMuonFilter > 0 && badChargedCandidateFilter > 0 && Flag_HBHENoiseFilter > 0 && Flag_HBHENoiseIsoFilter > 0 && Flag_goodVertices > 0 && Flag_EcalDeadCellTriggerPrimitiveFilter > 0"
	...
	path = locations.dataSetPathSignal
	outpath = locations.dataSetPathSignalNLL
	...
	inputFiles = {
					...
					"FastSimElectronIDScaleFactorFile":"FastSimScaleFactorElectronID.root",
					"FastSimElectronIDScaleFactorHisto":"histo2D",
					"FastSimElectronIsoScaleFactorFile":"FastSimScaleFactorElectronIso.root",
					"FastSimElectronIsoScaleFactorHisto":"histo2D",
					"FastSimElectronConvVetoScaleFactorFile":"FastSimScaleFactorElectronConvVeto.root",
					"FastSimElectronConvVetoScaleFactorHisto":"histo2D",
					
					"FastSimMuonIDScaleFactorFile":"FastSimScaleFactorMuonID.root",
					"FastSimMuonIDScaleFactorHisto":"histo2D",
					"FastSimMuonIsoScaleFactorFile":"FastSimScaleFactorMuonIso.root",
					"FastSimMuonIsoScaleFactorHisto":"histo2D",
					"FastSimMuonIP2DScaleFactorFile":"FastSimScaleFactorMuonIP2D.root",
					"FastSimMuonIP2DScaleFactorHisto":"histo2D",
					"FastSimMuonSIP3DScaleFactorFile":"FastSimScaleFactorMuonSIP3D.root",
					"FastSimMuonSIP3DScaleFactorHisto":"histo2D",
					}
